   ...
   // Checks If Google Play Services Exist
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        sendLocationImgBtn.setOnClickListener(view -> {
          ...
          //  Log.d(TAG, "https://www.google.com/maps/search/?api=1&query=" + lat + "," + lng);
    ...
    private void getCurrentLocationUpdate() {
        ...
        fusedLocationProviderClient.requestLocationUpdates(locationRequest, new LocationCallback() {
            ...
            public void onLocationResult(@NonNull LocationResult locationResult) {
                ...
                userDetailsClass.setLat(latlng.latitude);
                userDetailsClass.setLng(latlng.longitude);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_btn_download:
                Toast.makeText(MapsActivity.this, "Not Available Yet !", Toast.LENGTH_SHORT).show();
                return true;
    ...
    protected void animateToLocationBearing(Location position) {
       ...
       // position.setBearingAccuracyDegrees(180);
